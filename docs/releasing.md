...
The current published tuple requires Automation 0.1.0 and therefore Contribution 0.1.0 and Access Context 0.1.0. The Automation readiness successor adopts Contribution 0.1.1 and Access Context 0.1.1. After that exact successor is released and verified, update Integration's Automation, Contribution and Access Context pins together and rerun all package gates. Never claim this pending dependency promotion has happened.
